...
function App() {
  return (() => {
    var _el$ = createElement("div"), _el$2 = createElement("h1"), _el$4 = createElement("h2"), _el$6 = createElement("h3"), _el$8 = createElement("p"), _el$9 = createTextNode(`Count: `), _el$0 = createElement("p");
    insertNode(_el$, _el$2);
    insertNode(_el$, _el$4);
    insertNode(_el$, _el$6);
    insertNode(_el$, _el$8);
    insertNode(_el$, _el$0);
    setProp(_el$, "className", "bg-neutral-800 flex items-center");
    insertNode(_el$2, createTextNode(`DVUI React Bridge`));
    ...
    insert(_el$8, count, null);
    insertNode(_el$0, createTextNode(`Here is the Zig favicon:`));
    insert(_el$, (() => {
      var _c$ = memo2(() => count() > 4);
      return () => _c$() && (() => {
        var _el$10 = createElement("p");
        insertNode(_el$10, createTextNode(`Greater than 4`));
        return _el$10;
      })();
    })(), null);
    insert(_el$, (() => {
      ...
      return () => _c$2() && (() => {
        var _el$12 = createElement("p");
        insertNode(_el$12, createTextNode(`Less than 0`));
        return _el$12;
      })();
    })(), null);
    return _el$;
