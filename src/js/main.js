...
var [mousePosition, setMousePosition] = createSignal({
  x: 0,
  y: 0
});
...
function App() {
  ...
  return (() => {
    var _el$ = createElement("div"), _el$2 = createElement("p"), _el$3 = createTextNode(`Mouse position: `), _el$4 = createTextNode(`, `), _el$5 = createElement("p");
    insertNode(_el$, _el$2);
    insertNode(_el$, _el$5);
    setProp(_el$, "className", "mt-6 w-full");
    insertNode(_el$2, _el$3);
    insertNode(_el$2, _el$4);
    setProp(_el$2, "className", "text-neutral-300");
    insert(_el$2, () => mousePosition().x, _el$4);
    insert(_el$2, () => mousePosition().y, null);
    insertNode(_el$5, createTextNode(`Move the cursor to stress reactive updates.`));
    setProp(_el$5, "className", "text-neutral-400 text-sm mb-2");
    return _el$;
  })();
}
render2(App);
